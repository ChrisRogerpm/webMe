    ...
    r(function () {
        ...
        r(document).on("ready", function () {
            ...
            r("body")
                .on("mousemove", function (e) {
                    ...
                    s.addClass("transition"),
                        s.css({ "background-position": "calc( 50% + " + o + "px ) calc( 50% + " + i + "px )" }),
                        setTimeout(function () {
            ...
            a.imagesLoaded(function () {
                ...
                r(".portfolio-page-carousel").each(function () {
                    r(this).imagesLoaded(function () {
                        r(".portfolio-page-carousel").owlCarousel({ smartSpeed: 1200, items: 1, loop: !0, dots: !0, nav: !0, navText: !1, autoHeight: !0, margin: 10 });
                    });
                });
            var t,
                o = r(".blog-masonry");
            o.imagesLoaded(function () {
                ...
                r(".text-rotation").owlCarousel({ loop: !0, dots: !1, nav: !1, margin: 10, items: 1, autoplay: !0, autoplayHoverPause: !1, autoplayTimeout: 3800, animateOut: "fadeOut", animateIn: "fadeIn" }),
                ...
                r(".ajax-page-load-link").magnificPopup({ type: "ajax", removalDelay: 300, mainClass: "mfp-fade", gallery: { enabled: !0 } }),
                r(".portfolio-page-wrapper .portfolio-grid").each(function () {
                    r(this).magnificPopup({ delegate: "a.gallery-lightbox", type: "image", gallery: { enabled: !0 } });
                }),
                r(".form-control").val(""),
